...
public class Conditional
{
    ...
    public static final Conditional wet = new Conditional("ner.wet.text",Modifier.lightRed);
    public static final Conditional notWet = new Conditional("ner.notWet.text",wet);
    public static final Conditional hasPotion = new Conditional("ner.hasPotion.text",Modifier.lightRed);
    public static final Conditional hasNoPotion= new Conditional("ner.hasNoPotion.text",hasPotion);
    public static final Conditional beyond = new Conditional("ner.beyond.text",Modifier.lightRed);
    public static final Conditional nearer = new Conditional("ner.nearer.text",beyond);
    public static final Conditional raining = new Conditional("ner.raining.text",Modifier.lightRed);
    public static final Conditional dry = new Conditional("ner.dry.text",raining);
    public static final Conditional thundering = new Conditional("ner.thundering.text",Modifier.lightRed);
    public static final Conditional notThundering = new Conditional("ner.notThundering.text",thundering);
    public static final Conditional moonPhase = new Conditional("ner.moonPhase.text",Modifier.lightRed);
    public static final Conditional notMoonPhase = new Conditional("ner.notMoonPhase.text",moonPhase);
    public static final Conditional pastTime = new Conditional("ner.pastTime.text",Modifier.lightRed);
    public static final Conditional beforeTime = new Conditional("ner.beforeTime.text",pastTime);
    public static final Conditional pastWorldTime = new Conditional("ner.pastWorldTime.text",Modifier.lightRed);
    public static final Conditional beforeWorldTime = new Conditional("ner.beforeWorldTime.text",pastWorldTime);
    public static final Conditional pastWorldDifficulty = new Conditional("ner.pastWorldDifficulty.text",Modifier.lightRed);
    public static final Conditional beforeWorldDifficulty = new Conditional("ner.beforeWorldDifficulty.text",pastWorldDifficulty);
    public static final Conditional inDimension = new Conditional("ner.inDimension.text",Modifier.lightRed);
    public static final Conditional notInDimension = new Conditional("ner.notInDimension.text",inDimension);
    public static final Conditional inBiome = new Conditional("ner.inBiome.text",Modifier.lightRed);
    ...
    public static final Conditional below = new Conditional("ner.below.text",Modifier.lightRed);
    public static final Conditional above = new Conditional("ner.above.text",below);
    public static final Conditional playerOnline = new Conditional("ner.playerOnline.text",Modifier.lightRed);
    ...
    public static final Conditional aboveLooting = new Conditional("ner.aboveLooting.text",Modifier.lightRed);
    public static final Conditional belowLooting = new Conditional("ner.belowLooting.text",aboveLooting);
    public static final Conditional killedBy = new Conditional("ner.killedBy.text",Modifier.lightRed);
