...
public class ReliquaryCompat extends CompatBase
{
    ...
    {
        try // This will only work with beta version 1.2.257 of Reliquary
        {
        ...
        catch (NoSuchMethodError e) // This is the fallback if the official release version 1.2 is used
        {
            //Squid
