...
public class RenderHelper
{
    ...
    public static void renderEntity(int x, int y, float scale, float yaw, float pitch, EntityLivingBase entityLivingBase)
    {
        ...
        GL11.glTranslatef(0.0F, (float)entityLivingBase.getYOffset(), 0.0F);
        Minecraft.getMinecraft().getRenderManager().playerViewY = 180.0F;
        String temp = BossStatus.bossName;
        Minecraft.getMinecraft().getRenderManager().renderEntityWithPosYaw(entityLivingBase, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F);
